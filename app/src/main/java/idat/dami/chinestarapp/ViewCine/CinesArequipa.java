...
public class CinesArequipa extends Fragment {
    RecyclerView recyclerVCinesArequipa;
    ArrayList<Cine> listaCines;

    public CinesArequipa() {
        // Required empty public constructor
    }

    public static CinesArequipa newInstance(String param1, String param2) {
        CinesArequipa fragment = new CinesArequipa();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_cines_arequipa, container, false);
